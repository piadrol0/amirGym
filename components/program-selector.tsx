...
const programs = [
  ...
  {
    id: "amateur",
    title: "بدنسازی حرفه‌ای + برنامه غذایی",
    description: "ترکیبی از برنامه تمرینی و رژیم غذایی برای نتایج بهتر",
    icon: Dumbbell,
    price: "۲,۰۰۰,۰۰۰",
    features: ["برنامه ۴ روز در هفته", "رژیم غذایی اختصاصی", "پشتیبانی ۲۴ ساعته"]
  },
  {
    id: "nutrition",
    title: "برنامه غذایی",
